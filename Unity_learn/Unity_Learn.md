...
# Unity脚本启动顺序调整方法
https://www.cnblogs.com/czw52460183/p/11010971.html
...
![enter description here](./img/Unity脚本启动顺序调整方法%20001.png)
![enter description here](./img/Unity脚本启动顺序调整方法%20002-1.png)

![enter description here](./img/Unity脚本启动顺序调整方法%20002.png)

GameRoot是管理模块，PublicSvc是公共服务模块，SingleSys是单个业务系统模块，由于业务系统模块中需要用到公共服务模块提供的服务，因此需要先初始化公共服务模块，再初始化业务模块。

再看一下它们在系统中的排布：

![enter description here](./img/Unity脚本启动顺序调整方法%20003.png)

它们都放在空物体GameRoot下，方便GameRoot脚本取到对服务模块和业务模块的引用。

输出结果如下：

![enter description here](./img/Unity脚本启动顺序调整方法%20004.png)